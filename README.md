...
questions: {
    ...
    second: {
        ...
        startText: "Very much!",                   // Text before percentage
...
// Love Meter Messages
loveMessages: {
    extreme: "Awwww, you answered all the questions, You really like me that much huh?💖💌 // Shows above 5000%
